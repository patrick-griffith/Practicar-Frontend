...
function gameOver() {
    sound_dead()
    window.location = '/transformation/lose'
    // if (--player.lives > 0) {
    //    respawnPlayer()
    // } else {
...
function levelWin() {
    ...
    //showGameOver()
    window.location = '/transformation/win'
}
...
function initializeTheme() {
    spriteMap.src = '/jump-run/themes/' + theme + '/images/game_tiles.png';
    player.spriteMap.src = '/jump-run/themes/' + theme + '/images/player_sprites.png';
    player.sprite.x = 0
    player.sprite.y = 32
    preload_sounds()
